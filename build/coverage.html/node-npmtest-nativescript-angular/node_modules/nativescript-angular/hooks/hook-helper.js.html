...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nativescript-angular/node_modules/nativescript-angular/hooks/hook-helper.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nativescript-angular/node_modules/nativescript-angular/hooks/hook-helper.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nativescript-angular/node_modules/nativescript-angular/hooks/</a> &#187; hook-helper.js</div>
</div>
<div class="body">
...
exports.findProjectDir = function findProjectDir() {
    ...
    while (true) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (fs.existsSync(packageJsonFile)) {
            return candidateDir;
        }
<span class="cstat-no" title="statement not covered" >        if (oldCandidateDir === candidateDir) {</span>
